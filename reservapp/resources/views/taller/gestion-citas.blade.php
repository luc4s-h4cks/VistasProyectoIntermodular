                                ...
                                <div x-show="tab === 'solicitudes'">
                                    ...
                                    @else
                                        ...
                                        <div class="flex flex-wrap gap-4 pt-2">
                                            @foreach ($citas as $cita)
                                                @if ($cita->estado === 0)
                                                    <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm p-4 w-56 flex flex-col justify-between hover:border-blue-300 hover:shadow-md transition-all">
                                            ...
                                            @foreach ($citasPendientesPago as $cita)
                                                @php
                                                    $detalles = is_string($cita->detalles)
                                                        ...
                                                        : $cita->detalles;
                                                @endphp
                                                <div class="bg-white border-2 border-purple-200 rounded-lg shadow-sm p-4 w-64 flex flex-col justify-between hover:border-purple-400 hover:shadow-md transition-all">

                                                    {{-- Header badge --}}
                                                    <div class="flex items-center justify-between mb-3">
                                                        <span class="text-xs font-medium bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full">
                                                            💳 Pago en taller
                                                        </span>
                                                    </div>
                                                        ...
                                                        <div class="bg-gray-50 rounded-lg p-3 mb-3 space-y-1">
                                                            @foreach ($detalles as $detalle)
                                                                <div class="flex justify-between text-xs text-gray-600">
                                                                    ...
                                                                    <span class="font-medium whitespace-nowrap">{{ number_format(floatval($detalle['precio'] ?? 0), 2) }}€</span>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    @endif
