                ...
                <div class="flex w-full">
                    ...
                    <div class="flex-1 p-6" x-data="{
                        ...
                        <div id="modal-dia" x-show="abierto" x-cloak
                            ...
                            <div
                                class="bg-white rounded-xl shadow-xl w-[600px] max-h-[90vh] flex flex-col p-6 relative">
                                ...
                                <<button @click="window.location.href='{{ route('gestion-citas') }}'"
                                    ...
                                    <div class="flex-1 overflow-y-auto space-y-4 pr-2" style="max-height: 500px;">
                                        ...
                                        @if (isset($citas) && $citas->count() > 0)
                                                        ...
                                                        <div class="flex-1 grid grid-cols-2 gap-4">
                                                            ...
                                                            <div class="space-y-1">
                                                                <p class="text-sm"><span
                                                                        class="font-semibold">Usuario:</span>
                                                                    {{ $cita->coche->usuario->nombre }}</p>
                                                                <p class="text-sm"><span
                                                                        class="font-semibold">Marca:</span>
                                                                    {{ $cita->coche->marca }}</p>
                                                                <p class="text-sm"><span
                                                                        class="font-semibold">Modelo:</span>
                                                                    {{ $cita->coche->modelo }}</p>
                                                            </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div
                                                                    class="text-xs bg-gray-100 p-2 rounded h-16 overflow-y-auto">
                                                                    {{ $cita->motivo }}
                                                                </div>
                                                            </div>
                                            ...
                                            @endforeach
                                        @else
                                            <p class="text-center text-gray-500 mt-4">No hay citas para este día por
                                                ahora
                                            </p>
                                        @endif
