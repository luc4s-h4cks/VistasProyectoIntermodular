        ...
        <div class="max-w-4xl mx-auto space-y-4">
            ...
            @empty
                <div class="text-center py-12">
                    <svg class="mx-auto h-12 w-12 text-[var(--color-primary)] opacity-40" 
                    ...
                    <p class="mt-1 text-sm text-text opacity-60">
                        Comienza solicitando una cita con tu taller de confianza.
                    </p>
                </div>
            @endforelse
